...
\330(1;46 [●]Telegram group      | @AFGHAN HACK
\330(1;44 [●]Status                       | Gold
\330(1;48 [●]Version                     | 0.1"'
...
def randomClone():
	...
	for number in numbs
	    ids = inp + number
	     password = [number, ids, 123456, 123123,12345678, 10002000, ۱۲۳۴۵۶, ۱۲۳۴۵۶۷۸, afghanistan123, Afghanistan123, afghan123, Afghan123]
